...
description: GSAP 性能优化 — 优先用 transform/opacity、避免 layout thrashing、will-change、批量更新、gsap.quickTo() 高频属性优化 | 动画卡顿、掉帧、60fps 不流畅、性能调优、jank 排查、低端机适配、performance、FPS、smooth animation
license: MIT
---
