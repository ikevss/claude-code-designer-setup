...
description: GSAP 在 Vue/Nuxt/Svelte 等非 React 框架中的用法 — 生命周期挂载、选择器作用域、组件卸载清理 | 在 Vue 里做动画、Svelte 动画、Nuxt 动效、onMounted/onMount/onDestroy 里写 GSAP、框架集成、组件动画。React 项目请用 gsap-react。
license: MIT
---
