...
description: 页面切换过渡动画 | 路由跳转时的过渡效果、页面之间做淡入淡出/滑动切换、Next.js App Router页面切换动画、View Transitions API用法、Framer Motion AnimatePresence离开动画不生效的排查、SPA路由切换的进出动画 | page transition, route animation, View Transitions API, Next.js animation, AnimatePresence, SPA navigation
version: 0.1.0
---
