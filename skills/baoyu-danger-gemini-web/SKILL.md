...
description: "Gemini Web 图像生成 | 通过逆向 Gemini Web API 生成图像和文本，支持文生图、参考图视觉输入和多轮对话 | Gemini, image generation, text generation, vision, reverse-engineered API, AI image"
version: 1.56.2
metadata:
  openclaw:
