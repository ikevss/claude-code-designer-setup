---
name: gsap-plugins
description: GSAP 官方插件大全 — 注册方法、ScrollToPlugin 滚动定位、ScrollSmoother 平滑滚动、Flip 布局切换动画、Draggable 拖拽、Inertia 惯性、Observer 手势、SplitText 文字拆分动画、ScrambleText 乱码特效、DrawSVG/MorphSVG/MotionPath SVG 动画、物理引擎、CustomEase/CustomWiggle/CustomBounce 自定义缓动、GSDevTools 调试面板 | 要用 GSAP 哪个插件、插件怎么注册、文字逐字动画、SVG 描边绘制、SVG 形变、拖拽交互、页面平滑滚动、滚动到指定位置、Flip 动画、插件大全
license: MIT
---
