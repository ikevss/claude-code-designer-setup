 ...
 *   - critique:  the latest cached critique score (.idesign/critique)
...
import { getCritiqueDir } from './lib/idesign-paths.mjs';
...
// .idesign/, issue #303), a build artifact, or a dependency. Mirrors the
