...
Options:
  ...
  --no-design-system  Do not load local DESIGN.md / .idesign/design.json context
...
Project config:
  Respects .idesign/config.json and .idesign/config.local.json detector
