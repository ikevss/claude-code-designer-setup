...
/** `.idesign/design.json`, as documented in reference/document.md Step 4b. */
...
const PRODUCT_STAMP_RE = /^[ \t]*<!--[ \t]*idesign:product-schema[ \t]+(\d+)[ \t]*-->[ \t]*$/im;
...
export function productStampLine(version = PRODUCT_SCHEMA_VERSION) {
  return `<!-- idesign:product-schema ${version} -->`;
}
