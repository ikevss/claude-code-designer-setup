 ...
 * DESIGN.md and its `.idesign/design.json` sidecar, `.idesign/config.json`,
 ...
 * idesign-paths (which resolves the project root) and context.mjs (which
 * cannot import idesign-paths without a cycle) share one definition of
 ...
 *
 * `sidecarCandidates` comes from idesign-paths' resolver so this module
 ...
 */
export function checkProjectRoots({ patterns = [], candidates = [], configuredIn = '.idesign/config.json' }) {
