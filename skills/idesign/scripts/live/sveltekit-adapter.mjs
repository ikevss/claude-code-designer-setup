...
export const SVELTE_LIVE_ROOT_COMPONENT = 'src/lib/idesign/ImpeccableLiveRoot.svelte';
...
export const SVELTE_ROOT_IMPORT = "import ImpeccableLiveRoot from '$lib/idesign/ImpeccableLiveRoot.svelte';";
