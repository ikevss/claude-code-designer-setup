 ...
 *   IMPECCABLE_API_URL      — roll API base (default https://idesign.style/api).
...
const API_BASE = (process.env.IMPECCABLE_API_URL || 'https://idesign.style/api').replace(/\/$/, '');
...
const CARD_BASE = process.env.IMPECCABLE_CARD_BASE || 'https://idesign.style/worlds/cards';
