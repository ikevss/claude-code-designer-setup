 ...
 *   1. Check .idesign/live/config.json (returns config_missing if first-ever run)
...
import { readLiveServerInfo } from './lib/idesign-paths.mjs';
...
Prepare everything for live variant mode in a single command:
  - Checks .idesign/live/config.json (required, created once per project)
