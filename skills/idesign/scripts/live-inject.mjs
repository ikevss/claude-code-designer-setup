 ...
 *
 * On first live run, the agent generates `.idesign/live/config.json`
...
import { resolveLiveConfigPath } from './lib/idesign-paths.mjs';
import {
...
export const LIVE_IGNORE_PATTERNS = Object.freeze([
  '.idesign/hook.cache.json',
  '.idesign/hook.pending.json',
  '.idesign/config.local.json',
  '.idesign/live/server.json',
  '.idesign/live/sessions/',
  '.idesign/live/previews/',
  '.idesign/live/annotations/',
  '.idesign/live/artifacts/',
  '.idesign/live/accept-receipts/',
  '.idesign/live/locks/',
  '.idesign/live/cache/',
  '.idesign/live/manual-edit-apply-transaction.json',
  '.idesign/live/manual-edit-events.jsonl',
  '.idesign/live/manual-edit-evidence/',
  '.idesign/live/pending-manual-edits.json',
  '.idesign/live/deferred-svelte-component-accepts.json',
  '.impeccable-live.json',
  '.impeccable-live/',
  'app/.impeccable-live/',
  'src/.impeccable-live/',
  'node_modules/.impeccable-live/',
  'src/lib/idesign/ImpeccableLiveRoot.svelte',
  'src/lib/idesign/__runtime.js',
  'src/lib/idesign/[0-9a-f]*/',
...
Reads configuration from .idesign/live/config.json.

Modes:
  --port PORT   Insert script tag pointing at http://localhost:PORT/live.js
  --remove      Remove the script tag (if present)
  --check       Print whether .idesign/live/config.json exists and its content
