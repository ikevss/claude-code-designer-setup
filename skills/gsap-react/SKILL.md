---
name: gsap-react
description: GSAP 在 React/Next.js 中的最佳实践 — useGSAP Hook、refs 绑定、gsap.context() 作用域隔离、组件卸载自动清理、contextSafe 安全回调、SSR 避坑 | React 里怎么做动画、Next.js 动画、useGSAP 怎么用、useEffect 里写 GSAP、组件销毁后动画泄漏、scope 作用域、SSR 报 GSAP 错
license: MIT
---
