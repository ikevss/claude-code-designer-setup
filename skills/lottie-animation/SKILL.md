...
description: Lottie 动画集成 | 在网页/App里播放AE导出的Lottie动画、让动画跟着滚动播放、运行时改Lottie颜色、控制播放/暂停/跳转/速度、用Lottie做loading动效或空状态插图、AE动画导出为Lottie的注意事项 | Lottie, dotLottie, Bodymovin, After Effects, JSON animation, scroll-driven Lottie
version: 0.1.0
---
