---
name: glassmorphism
description: 毛玻璃效果（Glassmorphism） | 做个苹果风格的半透明模糊卡片、毛玻璃导航栏、磨砂弹窗/对话框、hover时玻璃折射效果、液态玻璃背景、frosted glass UI | glassmorphism, frosted glass, backdrop-filter, translucent panel, Apple glass effect
version: 0.1.0
---
