...
description: 无障碍动画与减少动效 | 用户嫌动画太晃眼、有人会晕动症、需要尊重系统"减少动态效果"设置、WCAG无障碍合规、给动画加prefers-reduced-motion开关、GSAP/Framer Motion的无障碍适配、分级减动效方案（不是一刀切关掉） | accessible animation, prefers-reduced-motion, vestibular, WCAG, reduced motion, useReducedMotion
version: 0.1.0
---
